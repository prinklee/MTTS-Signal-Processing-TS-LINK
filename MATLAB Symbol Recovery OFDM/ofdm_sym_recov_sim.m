...
% Add simulated delta freq, delta phase and noise to signal 
...
% Calculate metric M(d) to determine symbol timing
...
% Remove cyclic prefix from symbols 
...
% Correct for the fractional part of the frequency 
...
% Correct the integer part of the frequency 
...
% Calculate bit error rate for symbol 2 
for n = 1:T
