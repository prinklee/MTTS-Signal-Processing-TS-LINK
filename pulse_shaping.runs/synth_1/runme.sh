...
HD_PWD='C:/Users/priya/Vivado/pulse_shaping/pulse_shaping.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pulse.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pulse.tcl
