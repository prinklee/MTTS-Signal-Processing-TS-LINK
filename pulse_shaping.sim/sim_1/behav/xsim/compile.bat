...
REM
REM Generated by Vivado on Wed Nov 19 23:39:32 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj testbench_pulse_vlog.prj"
call xvlog  --incr --relax -L uvm -prj testbench_pulse_vlog.prj -log xvlog.log
