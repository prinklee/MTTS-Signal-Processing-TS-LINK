...
#                script (type 'sym1_bram.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/priya/MTTS-Signal-Processing-TS-LINK/ofdm_transmitter_hdl/ofdm_transmitter.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
