...
#
# Script generated by Vivado on Wed Dec 24 13:44:49 -0500 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : sym1_bram.sh
...
#
# Usage        : sym1_bram.sh
#                sym1_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sym1_bram.sh [-reset_run]
#                sym1_bram.sh [-reset_log]
#                sym1_bram.sh [-help]
#
...
# script info
echo -e "sym1_bram.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sym1_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sym1_bram xil_defaultlib.sym1_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sym1_bram -key {Behavioral:sim_1:Functional:sym1_bram} -tclbatch cmd.tcl -protoinst "protoinst_files/fft_ip.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sym1_bram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sym1_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sym1_bram.sh [-help]\n\
Usage: sym1_bram.sh [-step]\n\
Usage: sym1_bram.sh [-lib_map_path]\n\
Usage: sym1_bram.sh [-reset_run]\n\
Usage: sym1_bram.sh [-reset_log]\n\
Usage: sym1_bram.sh [-keep_index]\n\
Usage: sym1_bram.sh [-noclean_files]\n\n\
