...
#
# Script generated by Vivado on Mon Dec 22 21:42:27 -0500 2025
...
#
# Usage        : fft_ip.sh
#                fft_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fft_ip.sh [-reset_run]
#                fft_ip.sh [-reset_log]
#                fft_ip.sh [-help]
#
...
# script info
echo -e "fft_ip.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fft_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
simulate()
{
  xsim fft_ip -key {Behavioral:sim_1:Functional:fft_ip} -tclbatch cmd.tcl -protoinst "protoinst_files/fft_ip.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fft_ip.wdb xsim.dir libdpi.so)
...
Usage: fft_ip.sh [-step]\n\
Usage: fft_ip.sh [-lib_map_path]\n\
Usage: fft_ip.sh [-reset_run]\n\
Usage: fft_ip.sh [-reset_log]\n\
Usage: fft_ip.sh [-keep_index]\n\
