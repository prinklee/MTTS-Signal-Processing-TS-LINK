...
HD_PWD='C:/Users/priya/MTTS-Signal-Processing-TS-LINK/ofdm_transmitter_hdl/ofdm_transmitter.runs/message_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log message_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source message_bram.tcl
