...
HD_PWD='C:/Users/priya/MTTS-Signal-Processing-TS-LINK/ofdm_transmitter_hdl/ofdm_transmitter.runs/sym2_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sym2_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sym2_bram.tcl
