...
HD_PWD='C:/Users/priya/MTTS-Signal-Processing-TS-LINK/ofdm_transmitter_hdl/ofdm_transmitter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_ip_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_ip_wrapper.tcl -notrace
