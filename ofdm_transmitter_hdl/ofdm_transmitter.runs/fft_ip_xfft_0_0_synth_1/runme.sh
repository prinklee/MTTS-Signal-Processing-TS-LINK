...
HD_PWD='C:/Users/priya/MTTS-Signal-Processing-TS-LINK/ofdm_transmitter_hdl/ofdm_transmitter.runs/fft_ip_xfft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_ip_xfft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_ip_xfft_0_0.tcl
