...
REM
REM Generated by Vivado on Tue Dec 23 21:30:33 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_mapper_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_mapper_vlog.prj -log xvlog.log
